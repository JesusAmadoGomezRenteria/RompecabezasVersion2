...
//    opciones nuevas para el desarrollo
    ...
    public Tablero(int cantidadPieza) //Creamos nuestro tablero
    {
        ...
        etiTiempo.setBounds(500,20,80,250);
        etiTiempo.setForeground(Color.yellow);
        etiCronometro = new JLabel("0");
        etiCronometro.setBounds(550,135,100,20);
...
//        etiqueta1.setVisible(true);
        reloj = new Timer(10,
           ...
           new ActionListener()
           {
                    ...
                    public void actionPerformed(ActionEvent e) //Creamos el timer
                    {
                        ...
                        if(minutero==30) //Establecemos el tiempo limite para armar el rompecabezas
                        {
                        contador=0; 
        ...
        for(int i=0; i<cantidadPieza;i++)
        {
            ...
            pieza.setIcon(new ImageIcon("src\\imagenes2\\"+i+".jpeg"));//especificamos la direccion en la que estan las imagenes
...
//         Collections.shuffle(listaFragmento);
        ...
        boton1.setBounds(500,300,100,50);
        add(boton1);
        ...
        boton1.setBounds(500,200,100,50);
        add(boton1);
        boton1.addActionListener(this);
        boton1.addActionListener (new ActionListener(){
        public void actionPerformed(ActionEvent e){
...
//            Collections.shuffle(listaFragmentos);
 ...
 this.add(etiCronometro);
    ...
    {
        Tablero miTablero = new Tablero(4);
