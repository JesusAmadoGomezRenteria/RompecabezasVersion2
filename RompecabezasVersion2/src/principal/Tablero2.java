 ...
 * @author amado
 */
public class Tablero2 extends JFrame implements ActionListener {
...
//    opciones nuevas para el desarrollo
    ...
    public Tablero2(int cantidadPieza) //Creamos nuestro tablero
    {
        ...
        this.setBounds(0,0,700,600);// es el tamaño de mi JFRAME
        this.setLayout(null);
...
//        etiqueta1.setVisible(true);
        reloj = new Timer(10,
           ...
           new ActionListener()
           {
                    ...
                    public void actionPerformed(ActionEvent e)  //Creamos el timer
                    {
                        ...
                        if(minutero==90) //Establecemos el tiempo limite para armar el rompecabezas
                        {
                        contador=0; 
        ...
        for(int i=0; i<cantidadPieza;i++)
        {
            ...
            pieza.setIcon(new ImageIcon("src\\imagenes3\\"+i+".jpg"));//especificamos la direccion en la que estan las imagenes
...
//         Collections.shuffle(listaFragmento);
 ...
 Collections.shuffle(listaFragmento);// se revuelven la imagenes que estan en los contenedores
        for(int i = 0; i<listaFragmento.size(); i++)
        {
            listaFragmento.get(i).setBounds(x,y,100,100);  
            x+=100; 
           if(i==2){ //Delimitamos la primera linea de contenedores de imagen
              y+=100; 
              x=100;
           }
           if(i==5){ //Delimitamos la segunda linea de contenedores de imagen
              y+=100; 
              x=100;
           }
           if(i==8){ //Delimitamos la tercera linea de contenedores de imagen
              y+=100; 
              x=100;
           }
...
//            Collections.shuffle(listaFragmentos);
 ...
 this.add(etiCronometro);
    ...
    {
        Tablero2 miTablero = new Tablero2(12);
